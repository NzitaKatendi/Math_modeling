...
$$
\begin{cases}
	\frac{dM_1}{d\theta} = M_1 - \frac{b + 0.00041}{c_1} M_1 M_2 - \frac{a_1}{c1} M_1^2\\
...
p_cr = 50; #критическая стоимость продукта
tau1 = 36; #длительность производственного цикла фирмы 1
p1 = 10; #себестоимость продукта у фирмы 1
tau2 = 30; #длительность производственного цикла фирмы 2
p2 = 12; #себестоимость продукта у фирмы 2
...
function F(du, u, p, t)
    du[1] = u[1] - (a1/c1)*u[1]*u[1] - (b/c1 + 0.00041)*u[1]*u[2];
    du[2] = (c2/c1)*u[2] - (a2/c1)*u[2]*u[2] - (b/c1)*u[1]*u[2];
end
...
parameter Real p_cr = 50; //критическая стоимость продукта
parameter Real tau1 = 36; //длительность производственного цикла фирмы 1
...
parameter Real V = 50; //число потребителей производимого продукта
...
equation
der(M1) = (c1/c1)*M1 - (a1/c1)*M1*M1 - (b/c1 + 0.00041)*M1*M2;
